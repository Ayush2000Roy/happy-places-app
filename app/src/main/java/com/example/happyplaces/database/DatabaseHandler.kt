...
class DatabaseHandler(context: Context):
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_TABLE_HAPPY_PLACE = ("CREATE TABLE " + TABLE_HAPPY_PLACE + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_TITLE + " TEXT," + KEY_IMAGE + " TEXT,"
                + KEY_DESCRIPTION + " TEXT," + KEY_DATE + " TEXT," + KEY_LOCATION + " TEXT,"
                + KEY_LATITUDE + " TEXT," + KEY_LONGITUDE + " TEXT)")
        db?.execSQL(CREATE_TABLE_HAPPY_PLACE)
    }
    ...
    fun addHappyPlace(happyPlace: HappyPlaceModel): Long{ // Since, "insert" returns 'long' type
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int{ // Since, "update" returns 'Int' type
        val db = this.writableDatabase
        val contentValues = ContentValues()
        contentValues.put(KEY_TITLE, happyPlace.title)
        contentValues.put(KEY_IMAGE, happyPlace.image)
